  ...
  def create
    ...
    respond_to do |format|
      if @crypto_price.save
        format.html { redirect_to @crypto_price, notice: "Crypto price was successfully created." }
  ...
  def update
    respond_to do |format|
      if @crypto_price.update(crypto_price_params)
        format.html { redirect_to @crypto_price, notice: "Crypto price was successfully updated." }
